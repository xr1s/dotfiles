...
# 先按默认规则删词；如果删不动且左侧还有字符（标点），清空左侧全部字符
function backward-kill-word-prefix-punctuation() {
...
bindkey -- '^H'   backward-kill-word-prefix-punctuation          # C-Backspace 删除上一个单词
bindkey -- '^[^?' backward-kill-word-prefix-punctuation          # M-Backspace 删除上一个单词/符号
